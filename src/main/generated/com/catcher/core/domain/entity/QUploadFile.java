...
public class QUploadFile extends EntityPathBase<UploadFile> {
    ...
    private static final long serialVersionUID = 596989306L;

    public static final QUploadFile uploadFile = new QUploadFile("uploadFile");

    public final NumberPath<Long> contentId = createNumber("contentId", Long.class);

    public final EnumPath<com.catcher.core.domain.entity.enums.ContentType> contentType = createEnum("contentType", com.catcher.core.domain.entity.enums.ContentType.class);
